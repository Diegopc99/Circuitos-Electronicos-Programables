...
HD_PWD='/home/diego/Escritorio/CEP/Practica2/PS2/PS2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Unidad_Operativa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Unidad_Operativa.tcl
