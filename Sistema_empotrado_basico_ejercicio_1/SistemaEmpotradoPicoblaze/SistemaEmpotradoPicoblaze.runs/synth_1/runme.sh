...
HD_PWD='/home/diego/Escritorio/Sistema_empotrado_basico_ejercicio_1/SistemaEmpotradoPicoblaze/SistemaEmpotradoPicoblaze.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sistema_empotrado.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sistema_empotrado.tcl
