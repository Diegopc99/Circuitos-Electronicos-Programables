...
HD_PWD='/home/diego/Escritorio/CEP/Practica1.1/Practica1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Temporizador_placa.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Temporizador_placa.tcl -notrace
